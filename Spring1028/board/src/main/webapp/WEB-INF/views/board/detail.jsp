...
<div class="container mt-3">
 ...
 <form action="${root}/board/update" method="get">
  <div class="mb-3 mt-3">
   ...
   <div class="mb-3 mt-3">
    ...
    <input type="text" class="form-control" id="subject" placeholder="Enter subject" name="subject" value="${list.subject }" readonly>
  </div>
  <div class="mb-3 mt-3">
      <label for="content">내용:</label>
      <textarea class="form-control" rows="10" id="content" name="content" readonly>${list.content }</textarea>
    </div>
